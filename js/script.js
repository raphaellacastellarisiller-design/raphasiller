...
const SERVICES = {
  ...
  storymaker: {
    ...
    kind: 'story',
    videos: [
      { src: 'assets/videos/storymaker/story-01.mp4', poster: 'assets/videos/storymaker/story-01-poster.jpg', letterbox: true },
      { src: 'assets/videos/storymaker/story-02.mp4', poster: 'assets/videos/storymaker/story-02-poster.jpg', letterbox: true },
...
function buildGallery(service) {
  ...
  for (let i = 1; i <= total; i++) {
    ...
    if (service.images) {
      ...
      if (service.videos[i - 1].letterbox) video.classList.add('video-letterbox');
    } else {
